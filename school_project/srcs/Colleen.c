/*
	Program that dump its own source code
*/
# include <stdio.h>
# include <stdlib.h>
...
int main()
{
	...
	char *payloads = "/*\n\ttest the function\n*/\nint\tpayload( void )\n{\n\treturn 0;\n}\n\n";
	char *format_string = "%s%s\n%sint main()\n{\n\tchar *includes = \"%s\";\n\tchar *common = \"%s\";\n\tchar *payloads = \"%s\";\n\tchar *format_string = \"%s\";\n\t/*\n\t\tCall the payload of the function\n\t*/\n\tpayload();\n\n\t/* Display includes */\n\n\tdprintf(1, format_string, includes, common, payloads, make_program(includes), make_program(common), make_program(payloads), make_program(format_string));\n\tdelUniqMalloc();\n\treturn 0;\n}\n";
	/*
		Call the payload of the function
	*/
	payload();
