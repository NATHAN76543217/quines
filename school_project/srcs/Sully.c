...
# define START if (!ft_strcmp(current_filename, ft_strjoin("Sully_", ft_strjoin(ft_itoa(counter), ".c"))))counter--;if (counter < 0) return 0; char *filename = ft_strjoin("Sully_", ft_strjoin(ft_itoa(counter), ".c")); if ((fd = open(filename, 0x0002 | 0x0400 | 0x0200 , 0000700 | 0000070)) < 0) return 0;
